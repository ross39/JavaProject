...
{  
memoryButton[i]=new Memory(tempX,y,WIDTH,HEIGHT,memoryButtons[i], this);  
...
{  
specialButton[i]=new Special(tempX,y,WIDTH*2,HEIGHT,specialButtons[i], this);  
...
{  
digitButton[i]=new Digits(tempX,y,WIDTH,HEIGHT,DigitalButtons[i], this);  
...
{  
tempX+=WIDTH+H_SPACE;  
operatorButton[i]=new Operation(tempX,y,WIDTH,HEIGHT,operatorButtons[i], this);  
